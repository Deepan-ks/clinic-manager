...
public class InvoiceServiceImpl implements InvoiceService {
        ...
        public byte[] generateInvoice(Long billId) throws IOException {
                ...
                info.addCell(patientInfoCell("BILL TO",
                                "Patient Name: " + bill.getPatient().getName(),
                                "Age & Gender: " + bill.getPatient().getAge() + " / " + bill.getPatient().getGender(),
                ...
                for (BillItem item : bill.getItems()) {
                        ...
                        table.addCell(bodyCell(item.getService().getDescription() != null
